...
export const AmountPending = function({AmountPendingTitle, AmountPendingAmount, AmountPendingOrderCount}) {
    return <div className="bg-white rounded-[8px] shadow-sm p-5 h-fit"> 
        ...
        <div className="flex justify-between">
            ...
            {AmountPendingOrderCount ? <div className="flex mt-1">
                <div className="text-blue-500 font-medium underline">
                {AmountPendingOrderCount} Orders
                </div>
                <div className="mt-1">
