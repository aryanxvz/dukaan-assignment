...
export const NextPayout = ({nextPayoutTitle, nextPayoutAmount, nextPayoutOrderCount, nextPayoutSecondTitle, nextPayoutDate}) => {
    ...
    <div className="text-white pr-4 pl-4">
        ...
        <div className="flex justify-between pb-5">
            ...
            {nextPayoutOrderCount ? <div className="flex mt-1">
                <div className=" font-medium underline">
                {nextPayoutOrderCount} Orders
                </div>
                <div className="mt-1">
